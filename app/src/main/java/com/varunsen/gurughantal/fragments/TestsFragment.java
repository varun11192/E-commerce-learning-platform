...
public class TestsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CourseMaterialActivity.firestore.collection("PurchasedCourses").document(CourseMaterialActivity.productId)
                ...
                .document("tests").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    CommonMaterialAdapter adapter = new CommonMaterialAdapter(titleList, idList, Variables.TESTS);
