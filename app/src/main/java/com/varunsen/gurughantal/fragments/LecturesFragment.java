    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(manager);
            ...
            CourseMaterialActivity.firestore.collection("PurchasedCourses").document(CourseMaterialActivity.productId)
                    ...
                    .document("lectures").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                @Override
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    ...
                    if (task.isSuccessful()){
                        ...
                        CommonMaterialAdapter adapter = new CommonMaterialAdapter(titleList, urlList, Variables.LECTURES);
